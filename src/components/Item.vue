<template>
        ...
        <div v-if="!this.isInputDiv">
            <div class="row">
                <button class="itemButton" id="deleteButton">
                    <span @click="$store.commit('deleteItem', item)" class="svgs">
                ...
                <button class="itemButton" id="editButton">
                    <span @click="editItem" class="svgs">
    ...
    <div class="item" v-if="item.isDeleted && $store.state.isDeleted">
        ...
        <button class="itemButton">
            <span @click="$store.commit('undeleteItem', item)" class="svgs">
                <svg xmlns="http://www.w3.org/2000/svg" width="15" height="15" fill="currentColor" class="bi bi-recycle" viewBox="0 0 16 16">
